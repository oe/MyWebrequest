...
define(function(require) {
  var addRule, collection, initSection, isSafe4Qr, isUnionCat, modal, removeRule, resetSectionCtrlsState, testUrl, tpl, utils, vars;
  ...
  isUnionCat = function(cat) {
    return ~['block', 'hotlink', 'hsts', 'log', 'custom'].indexOf((cat || '').replace('#', ''));
  };
  ...
  $('#request-settings .switch-input').on('change', function(e) {
    ...
    utils.setSwitch(cat, this.checked);
  });
