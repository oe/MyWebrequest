...
$(function($) {
  var QRAPIHOST, QRAPIURL, TABNODATATR, addRule, deleteRules, dialogOKCB, getCustomFavorGsearch, getObjValues, getVcardString, hash, hideDialog, hideInputDialog, hostReg, initRequestSection, initUtility, ipReg, isValueInObj, pathReg, rules, showDialog, showTip, updateFavorGsearchOnview;
