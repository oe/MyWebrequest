...
all six locales, verifies persistence and compact-layout overflow, covers representative legacy `localStorage`
...
gate, not evidence that a branded Chrome, Edge, or Firefox row has passed its store or installed-browser
certification.
