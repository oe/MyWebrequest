...
export const homeCopy: Record<Locale, HomeCopy> = {
  en: {
    ...
    title: 'Make links go where you want',
    description:
      'Create your own redirects: open one web address and go straight to the page you choose. Your rules stay in your browser. No account needed.',
  ...
  'zh-CN': {
    ...
    title: '让网址跳转到你想去的地方',
    description:
      '为常用网址设置自己的跳转规则：打开原网址，自动前往你指定的页面。规则只保存在浏览器中，无需账号。',
    quickStart: '快速上手',
  ...
  ko: {
    ...
    title: '링크를 원하는 페이지로 연결하세요',
    description:
      '나만의 리디렉션 규칙을 만드세요. 원래 주소를 열면 지정한 페이지로 바로 이동합니다. 규칙은 브라우저에만 저장되며 계정이 필요하지 않습니다.',
    quickStart: '빠르게 시작하기',
  ...
  ja: {
    ...
    title: 'リンクの行き先を、自分で決める',
    description:
      '元の URL を開いたら、指定したページへ自動で移動。自分だけのリダイレクトルールを作れます。ルールはブラウザ内に保存され、アカウントは不要です。',
    quickStart: 'まず使ってみる',
  ...
  fr: {
    ...
    title: 'Vos liens, la destination de votre choix',
    description:
      'Créez vos propres redirections : ouvrez une adresse web et accédez directement à la page choisie. Vos règles restent dans votre navigateur. Aucun compte nécessaire.',
  ...
  es: {
    ...
    title: 'Lleva tus enlaces a donde tú quieras',
    description:
      'Crea tus propias redirecciones: abre una dirección web y ve directamente a la página que elijas. Tus reglas se guardan en el navegador. No necesitas una cuenta.',
