...
Archived 2026-09-09. These records describe earlier candidates, not current release approval. Relative code and artifact paths are repository-root paths. See the [current checklist](../release/RELEASE_CHECKLIST.md).

## Candidate review recorded September 6–7, 2026
...
- 2026-09-05 final review: `audit:store-assets` fails because the Chrome capture belongs to older release
  ...
  the blocker. See [RELEASE_REVIEW_2026-09-05.md](../archive/RELEASE_REVIEW_2026-09-05.md) and
