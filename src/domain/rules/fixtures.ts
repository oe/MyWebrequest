...
export const sampleRules: Rule[] = [
  {
    ...
    enabled: true,
    priority: 20,
    condition: { url: { kind: 'wildcard', value: 'https://api.example.com/v1/*' } },
  ...
  },
  {
    ...
    enabled: true,
    priority: 15,
    condition: { url: { kind: 'wildcard', value: 'https://images.example.com/*' }, resourceTypes: ['image'] },
  ...
  },
  {
    ...
    enabled: false,
    priority: 5,
    condition: { url: { kind: 'wildcard', value: 'https://search.example.com/*' } },
